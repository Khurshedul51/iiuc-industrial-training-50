...
temperatures = [23, 45, 67, -35]
thresold_tempurature = 25
for temperature in temperatures:
    if temperature > thresold_tempurature:
        print(f'temperature {temperature} is more than thresold tempurature {thresold_tempurature}')
...
for key, value in products.items():
    print(f'stock of {key} is {value["stock"]}')
    if(value["stock"] < value["min_required"]):
        print(f'stock is lower than min required! restock needed of {value["min_required"]-value["stock"]}')
