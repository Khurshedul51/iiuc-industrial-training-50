...
my_tuple = ("Sakib", 24, "Patiya")
print(my_tuple)

key_tuple = ("name", "age", "city")
tuple_dict = dict(zip(key_tuple, my_tuple))
print(tuple_dict)
...
# sorting by grads in ascending order
student_results.sort(key = lambda s: s[1])
print(student_results)

# sorting by grads in descending order
student_results.sort(key=lambda s: s[1], reverse=True)
print(student_results)
