...
username = "sakib_bodda"
is_correct_username = False
password = "kene cholor"
is_correct_password = False

if username == "sakib_bodda":
...
is_snowing = input("Is it snowing? (yes/no): ").strip().lower() == "yes"

if temperature > 25:  # Warm weather
    if is_sunny:
        print("It's a beach day!")
    else:
        print("It's warm but not sunny. Stay home!")
elif temperature <= 0:  # Freezing or below
    if is_snowing:
        print("It's a skiing day!")
    else:
        print("It's cold but not snowing. Stay home!")
else:  # Mild weather
    if is_sunny:
        print("It's mild and sunny, but not a beach or skiing day. Stay home!")
    else:
        print("It's mild but not sunny. Stay home!")
