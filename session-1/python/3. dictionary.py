...
# remove an key-value pair from last
last_removed_pair = student.popitem()
print(last_removed_pair)

# update 
student.update({last_removed_pair[0]: last_removed_pair[1]})
...
students = {
    'Sakibul Alam': [3.45, 3.67, 3.8, 4.0],
    'Rakibul Alam': [3.4, 3.6, 3.2, 3.7],
    'Didarul Alam': [3.2, 3.7, 3.67, 3.8]
}

for student_name in students.keys():
    grades = students.get(student_name)
    avg = sum(grades) / len(grades)
    print(f'student name: {student_name}  avg_grades: {avg: .2f}')
