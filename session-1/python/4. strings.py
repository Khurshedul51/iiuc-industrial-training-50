...
bio = "name: Khurshedul Alam, age: 24, country: Bangladesh"
...
formatted_string = f'name: {personal_info["name"]}\nage:{personal_info["age"]}\ncity:{personal_info["city"]}'
...
# Write your code below:
def get_chars_count(s: str) -> dict:
    return {c: s.count(c) for c in s}

print(get_chars_count("hello bodda ken acho"))
...
# 0088785674657
# 01845-567567
pattern = r'(?:\+?88)?01[3-9]\d{2}-?\d{6}'
phone_numbers = re.findall(pattern, "+8801454565767")
print(f'phone_number = {phone_numbers}')
